										...
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												<TR>
													<TD>客户名称：</TD>
													<TD>
														<INPUT class=textbox id=sChannel2 style="WIDTH: 80px" maxLength=50 name="custName"></TD>
									...
									<TD>
										<TABLE id=grid
											...
											<TBODY>
												...
												<%--struts2标签迭代 如果没有var属性将集合中的对象放到root栈顶,如果有var属性--%>
												<s:iterator value="list" var="c">
													...
													<TR
														...
														<TD><s:property value="#c.cust_linkman" /></TD>
														<TD><s:property value="#c.cust_phone" /></TD>
														<TD><s:property value="#c.cust_mobile" /></TD>
														<TD>
															<a href="${pageContext.request.contextPath }/customerServlet?method=edit&custId=<s:property value="#c.cust_id" />">修改</a>
															&nbsp;&nbsp;
															<a href="${pageContext.request.contextPath }/customerServlet?method=delete&custId=<s:property value="#c.cust_id" />">删除</a>
														</TD>
													</TR>
												</s:iterator>
