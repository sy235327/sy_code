				...
				<div
					...
					<form class="form-horizontal" method="post" action="${pageContext.request.contextPath}/user?method=login">
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<img src="${pageContext.request.contextPath}/user?method=code" />
							</div>
						</div>
						<div class="form-group">
							<div class="col-sm-offset-2 col-sm-10">
								<div class="checkbox">
									<label> <input type="checkbox" name="relogin" value="relogin"> 自动登录
										</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <label>
										<input type="checkbox" name="reuser" value="reuser"> 记住用户名
									</label>
								</div>
							</div>
						</div>
